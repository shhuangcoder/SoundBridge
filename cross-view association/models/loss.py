...
class CLIPLoss(nn.Module):
    ...
    def forward(self, outputs):
        ...
        atcloss = self.forward_loss(outputs['audio_embed'], outputs['text_embed'], outputs['logit_scale'])

#         loss['loss'] = itcloss['loss'] + atcloss['loss']
#         loss['clip_loss'] = itcloss['clip_loss'] + atcloss['clip_loss']
#         loss['clip_acc'] = itcloss['clip_acc'] + atcloss['clip_acc']

        loss['loss'] = itcloss['loss']
        loss['clip_loss'] = itcloss['clip_loss']
        loss['clip_acc'] = itcloss['clip_acc']
        
        loss['itc_loss'] = itcloss['loss']
        loss['itc_clip_loss'] = itcloss['clip_loss']
        loss['itc_clip_acc'] = itcloss['clip_acc']
        
        loss['atc_loss'] = atcloss['loss']
        loss['atc_clip_loss'] = atcloss['clip_loss']
        loss['atc_clip_acc'] = atcloss['clip_acc']
