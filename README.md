...
cross-modal retrieval: python -m torch.distributed.launch --nproc_per_node=NUM_GPU main_retrieval.py --config ./configs/train_egoexo.yml
```
...
cross-modal retrieval: python main_retrieval.py --config ./configs/test.yml
```
